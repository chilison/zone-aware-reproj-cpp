...
RandomPointGenerator::RandomPointGenerator(const Point &startPoint)
...
Point RandomPointGenerator::generateNextPoint(const Point &from, double distance_m, double azimuth_deg)
{
